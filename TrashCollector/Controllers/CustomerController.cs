...
namespace TrashCollector.Controllers
{
    public class CustomerController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Customers.Include(c => c.Account).Include(c => c.Address);
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,IdentityUserId,AdressId,AccountId")] Customer customer)
        {
